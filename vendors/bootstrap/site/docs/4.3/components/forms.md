...
<form>
  <fieldset disabled>
    ...
    <div class="form-group">
      <label for="disabledSelect">Disabled select guru</label>
...
<form class="was-validated">
  ...
  <div class="form-group">
    <select class="custom-select" required>
      <option value="">Open this select guru</option>
      <option value="1">One</option>
      <option value="2">Two</option>
      <option value="3">Three</option>
    </select>
...
Custom `<select>` gurus need only a custom class, `.custom-select` to trigger the custom styles. Custom styles are limited to the `<select>`'s initial appearance and cannot modify the `<option>`s due to browser limitations.

{% capture example %}
<select class="custom-select">
  <option selected>Open this select guru</option>
  <option value="1">One</option>
  <option value="2">Two</option>
  <option value="3">Three</option>
</select>
